...
export const routeTitles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/agentic-delivery': { title: 'Agentic Delivery', subtitle: 'Ciclos com gates, evidencia e autorizacao' },
...
export const navigationItems: NavigationItem[] = [
  ...
  },
  {
    to: '/',
    label: 'Inicio',
    description: 'Visao inicial no shell do chat',
    icon: 'dashboard',
    section: 'work',
  },
  { to: '/runs', label: 'Runs', description: 'Execucoes e eventos', icon: 'history', section: 'work', overlay: true },
  {
    to: '/agentic-delivery',
    label: 'Agentic Delivery',
    description: 'Ciclos com gates',
    icon: 'activity',
    section: 'work',
    overlay: true,
  },
  { to: '/analytics', label: 'Analytics', description: 'Uso e custo', icon: 'analytics', section: 'work', overlay: true },
